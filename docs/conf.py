...
project = "discourse2fedmsg"
copyright = "2020, Red Hat, Inc"
author = "Fedora Infrastructure"

# The short X.Y version
version = ".".join(discourse2fedmsg.__version__.split(".")[:2])

# The full version, including alpha/beta/rc tags
release = discourse2fedmsg.__version__
...
def run_apidoc(_):
    ...
    apidoc.main(
        [
            ...
            os.path.join(topdir, "discourse2fedmsg"),
            os.path.join(topdir, "discourse2fedmsg", "tests"),
        ]
    )
